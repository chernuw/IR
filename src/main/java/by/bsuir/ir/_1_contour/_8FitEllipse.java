 ...
 * @since 2020-04-09
 */
public class _8FitEllipse extends AbstarctOpenCV {
  ...
  public static void main(String[] args) {
    // Чтение изображения
    URL resource = _8FitEllipse.class.getResource("/figures2.png");
    ...
    for (int i = 0; i < contours.size(); i++) {
      ...
      if (contours.get(i).size().area() >= 5) {
        RotatedRect elps = Imgproc.fitEllipse(new MatOfPoint2f(contours.get(i).toArray()));
        Imgproc.ellipse(src, elps, new Scalar(0, 0, 0), 2);
      }
    }
