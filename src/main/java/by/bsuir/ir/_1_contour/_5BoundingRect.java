 ...
 * @since 2020-04-09
 */
public class _5BoundingRect extends AbstarctOpenCV {
  ...
  public static void main(String[] args) {
    // Чтение изображения
    URL resource = _5BoundingRect.class.getResource("/figures.png");
    ...
    for (int i = 0; i < contours.size(); i++) {
      ...
      Imgproc.rectangle(src, new Point(r.x, r.y), new Point(r.x + r.width, r.y + r.height), new Scalar(0, 255, 0), 2);
    }
